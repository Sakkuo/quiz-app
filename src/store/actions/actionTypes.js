...
export const NAME_QUIZ_HANDLE = 'NAME_QUIZ_HANDLE'
export const FINISH_CREATE_NAME = 'FINISH_CREATE_NAME'
export const SHIFT_QUIZ_NAME = 'SHIFT_QUIZ_NAME'
export const WRONG_PAS_EMAIL = 'WRONG_PAS_EMAIL'